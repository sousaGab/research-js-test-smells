...
// Requires @babel/parser and @babel/traverse (resolve via NODE_PATH, e.g.
//   NODE_PATH=llm-refactor-pipeline/src/llm_refactor/modules/detect_smells/get_method/node_modules)
const fs = require('fs');
